...
The status line reads one small file, starts no Git process, and makes no network request. On the development machine it renders in about 30 ms, most of which is process start. Formal measurements are planned.
